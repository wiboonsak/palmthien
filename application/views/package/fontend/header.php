...
<head>
	...
	<script async src="https://www.googletagmanager.com/gtag/js?id=UA-148003052-1"></script>
	<script>
	  window.dataLayer = window.dataLayer || [];
	  function gtag(){dataLayer.push(arguments);}
	  gtag('js', new Date());

	  gtag('config', 'UA-148003052-1');
	</script>
                    ...
                    <ul class="menu">                        
						...
						<li class="current-menu-item">
                            ...
                            <ul class="sub-menu">
                                ...
                                <li><a href="<?php echo base_url('Palmthien/Roomdetail/').$getCategory2->category_id?>"><?php echo $getCategory2->category_title?></a></li>   
