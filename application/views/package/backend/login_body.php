...
<html lang="en">
<head>
	<title>PALMTHIEN VILLA LOGIN</title>
	<meta charset="UTF-8">
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100" >
				<form class="login100-form validate-form" action="<?php echo base_url('login/gologin')?>" method="post">
					
					<span class="login100-form-title p-b-30">
						<img src="<?php echo base_url('HTML/images/logo-header.png')?>" alt="" height="60">
