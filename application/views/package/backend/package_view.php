 ...
 <?php $n = 1; 
    ...
    foreach ($packageData->result() AS $Data) {?>	
                                        <tr id="row<?php echo $Data->id ?>">
                                            ...
                                            <td align="center">
                                                <label>
                                                    <input id="ch<?php echo $Data->id ?>"  type="checkbox" class="js-switch js-check-change" onClick="setShow_onWeb('<?php echo $Data->id ?>', this.value, 'tbl_package')" value="<?php echo $Data->show_onweb ?>"  <?php
