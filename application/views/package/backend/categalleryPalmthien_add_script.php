...
<script type="text/javascript">
            ...
            $.ajax({
                ...
                success: function (data, status) {
                    ...
                    if (status == 'success') {
                        ...
                        setTimeout(function () {
                            window.location.href = "<?php echo base_url('PackageCMS/Category_PalmthienGallery') ?>" ;
                        }, 2000);
                    } else {
                        swal({
    ...
    //----------------------------------
   function  loadSeason() {
        $.post('<?php echo base_url('PackageCMS/loadcategallery/1') ?>', {}, function (data) {
		 ...
		 if((changeValue=='')){
			...
			$.post('<?php echo base_url('PackageCMS/updateOrderCategallery')?>',{ dataID:dataID , FieldName:FieldName , changeValue:changeValue }
				  ,function(data){ 
                    ...
                    setTimeout(function(){ window.location.href = "<?php echo base_url('PackageCMS/Category_PalmthienGallery')?>"; }, 2000);
