            ...
            <ul class="metismenu" id="side-menu">
                ...
                <li>
                    <a href="<?php echo base_url('PackageCMS/Category_Palmthien')?>">
                        <i class="fa fa-home"></i><span class="badge badge-danger badge-pill pull-right" style="background-color: #F9BC0B;"></span> <span>Room Type</span>
                    </a>
                </li>  
                <li>
                    <a href="<?php echo base_url('PackageCMS/Room_Palmthien')?>">
                        <i class="fa fa-home"></i><span class="badge badge-danger badge-pill pull-right" style="background-color: #F9BC0B;"></span> <span>Room Detail</span>
                    </a>
                </li>
                <li>
                    <?php 
                ...
                <li>
                    ...
                    <?php }?>
                        <i class="fa fa-home"></i><span class="badge badge-danger badge-pill pull-right" style="background-color: #F9BC0B;"></span> <span>Villa Detail</span>
                    </a>
                </li>
                <li>
                    <?php 
                ...
                <li> <p style="background-color: #5a5a5a; font-size: 15px; line-height: 2.6; padding-left: 20px; margin-bottom: 0px; color: #FFFFFF;"> <strong>Package Managing</strong> </p>
                    <!--</a>-->
                </li> 
                <li>
...
<script>
			...
			function DoChangePass(){
				...
				if(newpass==''){
					$('#ShowError').html('<span class="text-danger">New Password</span>');
					return false;
				}else if(cnewpass==''){
					$('#ShowError').html('<span class="text-danger">Confirm New Password</span>');
					return false;	
				}else if(newpass!=cnewpass){
					$('#ShowError').html('<span class="text-danger">New Password and Confirm Password incorrect.</span>');
					return false;	
				}else{
					$('#ShowError').empty();
