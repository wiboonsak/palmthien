...
$('.summernote').summernote({
            ...
            $.ajax({
                ...
                success: function (data, status) {
                    ...
                    if (status == 'success') {
                     ...
                     setTimeout(function(){ window.location.href = "<?php echo base_url('PackageCMS/packageAddLocal/')?>"+data; }, 2000);
        } else {
                        swal({
            ...
            swal({
                ...
                $.post('<?php echo base_url('PackageCMS/updateThis1') ?>', {Traveling: Traveling,Total:Total,adult_price:adult_price, aloneadult_price:aloneadult_price,child_price:child_price,addchild_price:addchild_price,currentID: dataID}, function (data) {
                    if (data > 0) {
                        ...
                        setTimeout(function () {
                            window.location.href = "<?php echo base_url('PackageCMS/packageAddLocal/') ?>" + packageID;}, 2000);
                    } else {
                        swal({
 ...
 setTimeout(function(){ window.location.href = "<?php echo base_url('PackageCMS/packageAddLocal/')?>"+currentID; }, 2000);
						   //------ images RowImg   file RowFile
					   }else{
						   swal({
							title: 'Error',
